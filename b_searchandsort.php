...
?>
<p> </p>
<div class="report">In script b_searchandsort.php</div>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  name = "searchzy620265" >
<?php
...
<p><input type="submit" name="submitss" id="submitss" value="Search"></p>
<input type="hidden" name="action" value="search" >
</form>
</section>
<div class="report">End of script b_searchandsort.php</div>
