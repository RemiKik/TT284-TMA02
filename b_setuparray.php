...
<div class="report">Setting up an array to match each column in the database table. In script b_setuparray.php</div>
<?php
...
?>
<div class="report">The array to match each column in the database table has been created. In script b_setuparray.php</div>
