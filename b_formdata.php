...
?>
<!--<div class="report">In script b_formdata.php Collecting data from $_POST.</div>
...
<div class="report">In script b_formdata.php Any data has been collected from $_POST. The data has been copied to our $webdata[] array</div>
