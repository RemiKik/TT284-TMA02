...
require "b_dbconnect.php";
 // script to conect to database
require "b_setuparray.php";
 // set up empty array to match the database table
require 'b_formdata.php';
 // add the script to process form input
...
?>
      ...
      if ($valid)
        {
        require "b_savedata.php";
 // script to save new data to the form
        }
      }
    if ($webdata['action'] == 'confirmdelete')
      {
      require "b_deletedata.php";
 // script to delete data from the form
      }
    }
  require "b_form.php";
 // add the input form
  require "b_displayalldata.php";
 // script to display all data from the form
